...
export const zh_TW: Translation = {
	...
	[Key.projectsDesktop]: "桌面應用程式",
	[Key.projectsOther]: "其他",
	[Key.projectTechStack]: "技術棧",
	[Key.projectLiveDemo]: "實況展示",
	...
	[Key.rssBenefit1]: "即時取得網站最新內容，無需自行拜訪",
	...
	[Key.atomWhatIsAtomDescription]:
		"Atom 聯合格式（Atom Syndication Format）是一個基於XML的標準，用於描述訂閱來源與其相關資訊。透過 Atom，你可以：",
	[Key.atomBenefit1]: "即時取得網站最新內容，無需自行拜訪",
